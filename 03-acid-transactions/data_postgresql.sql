...
-- manufacturer 1
insert into otus.manufacturer (id, description)
VALUES (1, 'manufacturer 1');

-- supplier 1
insert into otus.supplier (id, description)
VALUES (1, 'supplier 1');

-- product 1 + properties + price
insert into otus.product (id, manufacturer_id, supplier_id, description, count, deleted)
VALUES (1, 1, 1, 'product 1', 100, false);
insert into otus.product_property (product_id, property, description, comment)
...
insert into otus.product (id, manufacturer_id, supplier_id, description, count, deleted)
VALUES (2, 1, 1, 'product 2', 50, false);
insert into otus.product_property (product_id, property, description, comment)
